c      FUNCTION zbrent(x1,x2,tol)
      subroutine pionmass(x1,x2,tol,nres,zbrent)
      implicit none
      INTEGER ITMAX,nres
      double precision zbrent,tol,x1,x2,func,EPS
      EXTERNAL eigenv           !func
      ...
      write(30,*)'pion mass'
      write(30,*)'a,b',a,b
      call eigenv(b,nres,fb)
      call eigenv(a,nres,fa)
c      fa=fa-1
c      fb=fb-1
        write(30,*)'fa,fb',fa,fb
